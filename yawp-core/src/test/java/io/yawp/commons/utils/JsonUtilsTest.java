...
public class JsonUtilsTest extends EndpointTestCase {
    ...
    public void testXpto() {
        IdRef from = JsonUtils2.from(null, "\"/basic_objects/1\"", IdRef.class);
    }
    ...
    public void testFrom() {
        BasicObject object = JsonUtils2.from(null, DATA_OBJECT_JSON, BasicObject.class);
    ...
    public void testFromArray() {
        ...
        List<BasicObject> objects = JsonUtils2.fromList(null, json, BasicObject.class);
    ...
    public void testMapWithLongKey() {
        ...
        String json = JsonUtils2.to(map);

        map = JsonUtils2.fromMap(null, json, Long.class, String.class);
    ...
    public void testMapWithComplexObjectValue() {
        ...
        map = JsonUtils2.fromMap(null, json, Long.class, BasicObject.class);
    ...
    public void testMapWithListOfComplexObjectValue() throws NoSuchFieldException, SecurityException {
        ...
        String json = JsonUtils2.to(map);
        map = JsonUtils2.fromMapList(null, json, Long.class, BasicObject.class);
    ...
    public void testMapWithComplexKeyAndValue() {
        ...
        String json = JsonUtils2.to(map);
        map = (Map<IdRef<BasicObject>, BasicObject>) JsonUtils2.fromMapRaw(yawp, json, keyType, BasicObject.class);
