(function (t, yawp, fx) {
    ...
    t.asyncTest("create transformer", function (assert) {
        ...
        yawp('/children').from(parent).transform('simple').create(child).then(function (retrievedChild) {
    ...
    t.asyncTest("create array transformer", function (assert) {
        ...
        yawp('/children').from(parent).transform('simple').create(children).then(function (retrievedChidren) {
    ...
    t.asyncTest("update transformer", function (assert) {
        ...
        fx.load(function () {
            ...
            yawp(child.id).transform('simple').update(child).then(function (retrievedChild) {
